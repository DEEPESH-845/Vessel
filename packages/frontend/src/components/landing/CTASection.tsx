...
export function CTASection() {
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef} className="relative z-10 container-section text-center">
        {/* Section Label */}
        ...
        <p
          ref={descriptionRef}
          className="text-lg text-white/50 mb-[var(--space-8)] max-w-2xl mx-auto"
        >
        ...
        {/* Trust Badges */}
        <div ref={badgesRef} className="mt-[var(--space-12)] flex flex-wrap items-center justify-center gap-6">
          ...
          <div className="flex items-center gap-2 text-white/40">
            ...
            <span className="text-sm">Zero Gas</span>
          </div>
        </div>
      </div>
